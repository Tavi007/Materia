...
public class SelectMateriaEffectScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (collectionToEffectMapper.isEmpty()) {
            renderEmptySelection(guiGraphics, mouseX, mouseY, partialTicks);
        } else {
            renderEffectSelection(guiGraphics, mouseX, mouseY, partialTicks, collectionToEffectMapper);
        }
    }

    private void renderEmptySelection(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        drawSlices(guiGraphics, slices, centerOfScreenX, centerOfScreenY, animationProgress > 0.99f);
...
//                15728880);
    ...
    private void renderEffectSelection(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks,
...
//                15728880);
    ...
    private void drawSlices(GuiGraphics guiGraphics, List<SelectSlice> slices, int posX, int posY, boolean animationFinished) {
